    ...
    <ThemeProvider theme={theme}>
      <AppBar position="sticky" style={{ background: '#fff' }}>
        <Toolbar>
          ...
          <Typography variant="h6" sx={{ color: "rgb(119, 126, 137)", display: { xs: 'none', md: 'block' }, fontSize: "1rem" }}>Hi, julia</Typography>
          <IconButton onClick={handleClick}><KeyboardArrowDownIcon /></IconButton>
